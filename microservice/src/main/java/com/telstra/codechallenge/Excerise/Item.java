...
public class Item {
	...
	public String toString() {
		return "Item [login=" + login + ", id=" + id + ", node_id=" + node_id + ", name=" + name + ", full_name="
				+ full_name + ", _private=" + _private + ", html_url=" + html_url + ", description=" + description
				+ ", fork=" + fork + ", url=" + url + ", forks_url=" + forks_url + ", keys_url=" + keys_url
				+ ", collaborators_url=" + collaborators_url + ", teams_url=" + teams_url + ", hooks_url=" + hooks_url
				+ ", issue_events_url=" + issue_events_url + ", events_url=" + events_url + ", assignees_url="
				+ assignees_url + ", branches_url=" + branches_url + ", tags_url=" + tags_url + ", blobs_url="
				+ blobs_url + ", git_tags_url=" + git_tags_url + ", git_refs_url=" + git_refs_url + ", trees_url="
				+ trees_url + ", statuses_url=" + statuses_url + ", languages_url=" + languages_url
				...
				+ ", open_issues_count=" + open_issues_count + ", license=" + license + ", forks=" + forks
				+ ", open_issues=" + open_issues + ", watchers=" + watchers + ", default_branch=" + default_branch
				+ ", score=" + score + ", additionalProperties=" + additionalProperties + "]";
	}
